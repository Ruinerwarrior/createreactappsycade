module.exports = [
	...
	{ fileName: 'actions/index.ts', value: require('./actions/index.js'), reqconditions: ['redux', 'asyncactions'], conditions:[] },
	//constants folder
	{ fileName: 'constants/empty', value: null, reqconditions: [], conditions:[] },
	//types folder
	{ fileName: 'types/actions/index.ts', value: require('./types/actions/index.js'), reqconditions: ['asyncactions'], conditions:[] },
	{ fileName: 'types/state/index.ts', value: require('./types/state/index.js'), reqconditions: ['asyncactions'], conditions:[] },
  ...
  { fileName: 'containers/App/index.tsx', value: require('./containers/App.js'), reqconditions: [],conditions:[] },
	...
	//reducers folder
	{ fileName: 'reducers/asyncActionPayloadReducer.ts', value: require('./reducers/asyncActionPayloadReducer.js'), reqconditions: ['redux', 'asyncactions'], conditions:[] },
	{ fileName: 'reducers/asyncActionReducer.ts', value: require('./reducers/asyncActionReducer.js'), reqconditions: ['redux','asyncactions'], conditions:[] },
	{ fileName: 'reducers/asyncActionStatusReducer.ts', value: require('./reducers/asyncActionStatusReducer.js'), reqconditions: ['redux', 'asyncactions'], conditions:[] },
